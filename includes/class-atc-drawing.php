...
class Atc_Drawing
{
     ...
     * @since    1.0.0
     * @access   protected
     * @var      Atc_Drawing_Loader    $loader    Maintains and registers all hooks for the plugin.
     */
    protected $loader;
    ...
    {
        $plugin_i18n = new Atc_Drawing_i18n();
    ...
    private function define_admin_hooks()
    {
        ...
        $this->loader->add_action('init', $plugin_admin, 'clean_output_buffer');
    }
